...
🎯 Cel projektu
Celem projektu jest stworzenie konsolowej aplikacji do zarządzania budżetem domowym, która umożliwia:
...
**Hierarchia klas generowana automatycznie przez Doxygena została pominięta, ponieważ diagram UML przedstawia pełniejszą strukturę relacji między klasami uczestniczącymi w zastosowanych wzorcach projektowych.**
